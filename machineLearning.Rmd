...
Random forest was able to reach a perfect fit with the training data. Now let's check out-of-sample error with cross-validation against the (pre-)test set `trDeep_ts`:
...
Now, I'll import the test data I'll need to make the prediction, with the same cleanup procedure:
